...
(function (window, document, undefined) {
  ...
  function w(a, b) {
    for (
      var c = a.className.split(/\s+/), d = [], e = 0, f = c.length;
      e < f;
      e++
    )
      c[e] != b && d.push(c[e]);
  ...
  C.prototype.parse = function () {
    ...
    if (-1 != this.a.indexOf("MSIE")) {
      ...
      a: {
        ...
        if (-1 != this.a.indexOf("Opera Mini/")) {
          ...
          if (
            ...
            ((g = F(this.a, /Version\/([\d\.]+)/, 1)), (h = A(g)), h.e !== l)
          ) {
            a = new B(
              "Opera",
              h,
      ...
      "BuiltinBrowser" == f
        ? (h = "Unknown")
        : "Silk" == f
        ? (h = F(this.a, /Silk\/([\d\._]+)/, 1))
        : "Chrome" == f
        ? (h = F(this.a, /(Chrome|CrMo|CriOS)\/([\d\.]+)/, 2))
        : -1 != this.a.indexOf("Version/")
        ? (h = F(this.a, /Version\/([\d\.\w]+)/, 1))
        : "AdobeAIR" == f && (h = F(this.a, /AdobeAIR\/([\d\.]+)/, 1));
      g = A(h);
      n =
        "AdobeAIR" == f
          ? 2 < g.e || (2 == g.e && 5 <= g.o)
  ...
  function E(a) {
    ...
    if (
      b ||
      (b = F(a.a, /Windows Phone( OS)? ([^;)]+)/, 2)) ||
      (b = F(a.a, /(iPhone )?OS ([\d_]+)/, 2))
    )
      return b;
    if ((b = F(a.a, /(?:Linux|CrOS) ([^;)]+)/, 1)))
      for (var b = b.split(/\s/), c = 0; c < b.length; c += 1)
        if (/^[\d\._]+$/.test(b[c])) return b[c];
    return (a = F(a.a, /(BB\d{2}|BlackBerry).*?Version\/([^\s]*)/, 2))
      ? a
      : "Unknown";
  }
  function F(a, b, c) {
  ...
  function qa(a, b, c, d, e, f, g, h) {
    ...
    for (var n in O)
      O.hasOwnProperty(n) &&
        (M(a, new H(O[n], I(this.q))), (this.F[O[n]] = a.s.offsetWidth));
    a.remove();
  }
  ...
  function ra(a) {
    var b = a.A.s.offsetWidth,
      c = a.B.s.offsetWidth;
    (b === a.F.serif && c === a.F["sans-serif"]) || (a.k.T && sa(a, b, c))
      ? ea() - a.ya >= a.S
        ? a.k.T &&
          sa(a, b, c) &&
          (a.Z === l || a.Z.hasOwnProperty(a.q.getName()))
          ? P(a, a.V)
          : P(a, a.ta)
        : setTimeout(
            s(function () {
  ...
  R.prototype.ia = function (a) {
    var b = this.t;
    w(b.h, b.g.f(b.j, a.getName(), I(a).toString(), "loading"));
    ia(b.h, b.g.f(b.j, a.getName(), I(a).toString(), "active")) ||
      v(b.h, b.g.f(b.j, a.getName(), I(a).toString(), "inactive"));
    J(b, "fontinactive", a);
    ua(this);
  };
  function ua(a) {
  ...
  X.prototype.D = function (a, b) {
    var c = x(this.c),
      d = (this.d.api || "fast.fonts.com/jsapi").replace(
        /^.*http(s?):(\/\/)?/,
        ""
      );
  ...
  Z.prototype.X = function (a) {
    for (
      var b = this.c,
        c = new za(this.d.api, x(b), this.d.text),
        d = this.d.families,
        e = d.length,
        f = 0;
      f < e;
        ...
        (d.__webfontfontdeckmodule__[c] = function (a, c) {
          for (var d = 0, n = c.fonts.length; d < n; ++d) {
            ...
            e.m.push(
              new H(
                m.name,
                ma("font-weight:" + m.weight + ";font-style:" + m.style)
              )
            );
          }
          b(a);
